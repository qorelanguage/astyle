...
enum FileType { C_TYPE = 0, JAVA_TYPE = 1, SHARP_TYPE = 2, QORE_TYPE = 3 };
...
public:
  ...
  static const string AS_Q_REFERENCE, AS_Q_HASH;
  static const string AS_Q_LIST, AS_Q_ANY, AS_Q_AUTO, AS_Q_BINARY;
  static const string AS_Q_ON_SUCCESS, AS_Q_ON_ERROR, AS_Q_ON_EXIT;
  static const string AS_Q_SUB, AS_Q_OUR, AS_Q_MY;
  static const string AS_Q_NOTHING, AS_Q_NULL;
  static const string AS_Q_OBJECT, AS_Q_BACKGROUND;
  static const string AS_Q_SELECT, AS_Q_FOLDL, AS_Q_FOLDR;
  static const string AS_Q_WEEK_ASSIGN;
  static const string AS_Q_REG_EXP_MATCH, AS_Q_REG_EXP_NO_MATCH;
};  // Class ASResource
